...
import com.testosterolapp.letgoproject.util.Divot.Companion.sPositionChoices
...
class QuickContactDivot  : QuickContactBadge, Divot {
    ...
    private fun setDrawable() {
        val r = context.resources
        when (mPosition) {
            Divot.LEFT_UPPER, Divot.LEFT_MIDDLE, Divot.LEFT_LOWER -> mDrawable =
                r.getDrawable(R.drawable.msg_bubble_right)
            Divot.RIGHT_UPPER, Divot.RIGHT_MIDDLE, Divot.RIGHT_LOWER -> mDrawable =
                r.getDrawable(R.drawable.msg_bubble_left)
        }
        if (mDrawable != null) {
